...
- (void)setBtnRecord:(UIButton *)btnRecord
{
    _btnRecord = btnRecord;
}

- (void)setRecordButtonHidden:(BOOL)isHidden
{
    _btnRecord.hidden = isHidden;
}
...
- (void)setNeedsDisplay
{
    ...
    [self.btnRecord setNeedsDisplay];
}
